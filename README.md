...
📍 Berkeley, CA &nbsp;|&nbsp; 🎓 Haas MBA '26 &nbsp;|&nbsp; ⚡ Ex-Intuit, Rappi &nbsp;|&nbsp; 🌎 Lima → Silicon Valley
...
```bash
$ python main.py hunt      → scanning 18 companies... ✓
$ python main.py blitz     → tailored resume generated ✓
$ python main.py scout     → contacts scored and queued ✓
```
...
*open to senior pm roles at ai-native and consumer companies in the bay area*
